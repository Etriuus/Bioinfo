...
class GraphVisualizer:
    ...
    def setup_vertex_cover_params(self):
        ...
        self.graph_size = tk.StringVar(value="5")
        ttk.Label(frame, text="Tamaño del grafo:").pack(side='left')
        ttk.Entry(frame, textvariable=self.graph_size, width=10).pack(side='left', padx=(10, 0))
